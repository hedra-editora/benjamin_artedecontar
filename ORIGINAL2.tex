...
\chapterspecial{O Coração Gelado}{Peça de rádio baseada em Wilhelm Hauff\footnote[*]{``Das
  ...
  como testemunha uma carta na qual ele conta à Ernst Schoen ter
...
\textsc{Miguel o Holandês}\footnote{Na época, transportava-se a madeira
  ...
  escoras para as construções em solo pantanoso. [\versal{N}. do \versal{T}.]}
...
\textsc{Rei do Tablado} --- Também acho, preso junto, enforcado junto.\footnote{Expressão
  ...
  com as consequências. [\versal{N}. do \versal{T}.]}
...
\textsc{Anão de Vidro} --- A soberba vem amiúde antes da queda.\footnote{A
  ...
  espírito precede a queda.'' (Cf. Pr 16, 18) [\versal{N}. do \versal{T}.]} Vocês
...
caiqouettes\footnote{Termo pseudo-francês, criado pelos autores da peça.
  [\versal{N}. do \versal{T}.]}, des caiqouettes et des caiqouettes! Louvre! Torre
...
Linden}\footnote{\emph{Unter den Linden} (Sob as Tílias) é a avenida
  central de Berlim. [\versal{N}. do \versal{T}.]}, ele fala, com certo humor amargo,
...
Felpudo},\footnote{\emph{Max und Moritz} (1865), do escritor e
  ...
  populares da Alemanha. [\versal{N}. do \versal{T}.] Há edições brasileiras. Em se
...
--- A quem o ama, o Senhor concede o pão enquanto dorme.\footnote{Trata-se
  ...
  dorme.'' (Sl 127, 2) [\versal{N}. do \versal{T}.]}
...
existência diurna, mas sim sobre uma terra oposta ou paralela.\footnote{No
  ...
  criados por Benjamin. [\versal{N}. do \versal{T}.]} Era outra Positano, que
...
medo,\footnote{Alusão ao título do conto de fada dos irmãos Grimm,
  ...
  casa para aprender a ter medo''. [\versal{N}. do \versal{T}.]} nem qualquer
...
para a construção da famosa torre de Clavel.\footnote{Gilbert Clavel
  ...
  futurista. [\versal{N}. do \versal{T}.]} No próximo outono, fará um ano que esse
...
contemporâneos}\footnote{Cf. Ludwig Ernst von Borowski, Reinhold
  ...
  Felix Groß. Berlin: Deutsche Bibliothek, s. d. [1912]. [\versal{N}. do \versal{T}.]}, que representa um verdadeiro tesouro não apenas para o
...
\chapterspecial{Posfácio}{O Crítico e o contador}{por Patrícia Lavelle}
...
de sua mão na argila do vaso''.\footnote{\emph{Supra}, p. ? (\versal{GS} \versal{II}-2, p.
...
lado épico da verdade''.\footnote{\emph{Supra}, p. ? (\versal{GS} \versal{II}-2, p. 442).}
...
explicações a história contada''.\footnote{\emph{Supra}, p. ? (\versal{GS} \versal{II}-2,
  p. 445).}
...
fantasmagoria na qual ``o justo se encontra consigo mesmo''.\footnote{\emph{Supra},
  p. ? (\versal{GS} \versal{II}-2, p. 465).} Segundo ele, o primeiro contador verdadeiro é
...
o ser humano liberado.\footnote{\emph{Supra}, p.? (\versal{GS} \versal{II}-2, p. 458).}
\end{quote}
...
experiência''\footnote{\emph{Supra}, p.? (\versal{GS} \versal{II}-2, p. 446).}, diz ele ao
...
diferentes versões.\footnote{\emph{Supra}, p.? (\versal{GS} \versal{II}-2, p. 448).}
\end{quote}
...
fazer suas próprias tentativas interessantes''.\footnote{\emph{Supra},
  p.? (\versal{GS} \versal{IV}-2, p. 754).} Os contos de Benjamin são como essas máscaras
...
lenço que caíra ao chão''.\footnote{\emph{Supra}, p.? (\versal{GS} \versal{IV}-2, p. 744).}
