...
se a questão era tratá"-lo como uma pessoa demente ou um semisselvagem.
...
\chapter[O Coração Gelado]{O Coração Gelado \subtitulo{Peça de rádio baseada\break em Wilhelm Hauff\ \footnote[*]{``Das
  ...
  Pinheiro Machado. Peça radiofônica para crianças escrita
  por Benjamin e Ernst Schoen, seu antigo colega de escola,
  ...
  recebido o volume como presente de aniversário. [\versal{N}.\,\versal{E}.]}}}
  

\begin{flushright}
\hfill\textsc{walter benjamin \&\\
ernst schoen}
\end{flushright}
...
\versal{C} de Celsius, o contrário de Réaumur, \versal{D, E, F, G.}
...
--- mas, o que é isso? Que figuras estranhas vocês são! O que querem?

\versal{Peter Munk do Carvão} --- Somos as personagens do conto de fadas ``O
coração gelado'', de Wilhelm Hauff.

\versal{Locutor} --- Do ``Coração gelado'' de Wilhelm Hauff? Então é como se vocês
...
leva as toras rio abaixo,\footnote{Na época, transportava"-se a madeira
  ...
  escoras para as construções em solo pantanoso. [\versal{N}.\,\versal{T}.]} mas tudo isso de tamanho gigantesco, de
...
\versal{Rei do Tablado}, \emph{afetado} --- Permita"-me que me apresente, Sr.\,Locutor, sou o Rei do Tablado.
...
\versal{Locutor} --- Agora já chega de ouvir quem são vocês; a minha cabeça já
...
\versal{Peter Munk do Carvão} --- Veja, Sr.\,Locutor, já faz cem anos que estamos
no livro de contos de fadas de Hauff. Assim, só podemos falar apenas
para uma criança de cada vez. Mas dizem que agora está na moda as
personagens dos contos de fadas saírem dos livros para ir à Terra da
...
Deixe"-nos entrar em cena então, Sr.\,Locutor, sem cerimônia.
...
Claro, você não é feliz quando não pode ser visto com suas
...
da Rádio conhecemos a Terra da Voz como a palma da própria mão.

\versal{Miguel o Holandês}, \emph{grosseiro} --- Deixe a gente entrar, então, Sr.\,Locutor.
...
precisarei dar a condição que vocês têm que cumprir antes disso.
...
qualquer adorno e de qualquer beleza exterior para que lhe reste apenas a
...
Vocês têm ainda um tempinho para pensar.
...
\versal{Ezequiel}, \emph{sussurrando} --- Olhe lá! Também não é tão simples assim!
...
deles dessa maneira, seu malandro! \emph{Em voz alta:} Então, Sr.\,Locutor, estamos de acordo com sua condição.
...
\versal{Locutor} --- Claro, claro, e o que mais?
...
\versal{Rei do Tablado} --- Também acho, presos juntos, enforcados juntos.\footnote{Expressão
...
não se assuste se lhe digo que a gente se perdeu.

\versal{Peter Munk do Carvão} --- A gente se perdeu? Não acredito. Não havia
vozes?
...
\emph{Ouvem"-se pessoas dizendo} --- Boa noite, Locutor! Cuide"-se. Boa
noite! Até logo!

\versal{Moendeira} --- Entre e fique à vontade, Sr.\,Peter, pois parece que é
...
\versal{Peter Munk do Carvão} --- Certo, Sr.ª\,Moendeira. Mas permita"-me
...
Por isso temos que ter cobertores grossos quando começa a gear no inverno.

\emph{Ouvem"-se novamente algumas vozes} --- Bom descanso! Boa noite! Não
se esqueçam de apagar as velas!

\versal{Peter Munk do Carvão}, \emph{bocejando} --- Que coisa, não sabia que uma
pessoa podia ficar com tanto sono. Mesmo se o diabo entrasse agora, acho
...
da cidade de Bingen, ele teria pescado, com a haste que os madeireiros"-jangadeiros usam para espetar peixes no Reno, um pacote com peças de ouro,
que faria parte do grande tesouro dos Nibelungos que lá está
...
gigante da floresta, o rapaz selvagem e de ombros largos,
aqueles que, como garantem os que afirmam tê"-lo visto, não quer pagar do próprio
...
\versal{Filho do Moendeiro} --- Quer dizer que o senhor acabou de se encontrar com o
Anão de Vidro?
...
\emph{A musiquinha acaba. Depois de uma pausa, ouvem"-se seis batidas.}
...
\versal{Peter Munk do Carvão}, \emph{apressado} --- Deixe"-me, deixe"-me, Sr.\,Locutor. Lembrei do meu verso\ldots{}
...
terceiro posso recusar se for tolo. Então faça seus desejos, mas
que seja algo de bom e útil, Peter!
...
miserável Rei do Tablado lá fica?
Depois você não terá
mais nada durante uma semana e passará necessidade como antes. Vou lhe
...
ser o dono da fábrica de vidro mais bonita e mais rica de toda a
...
\versal{Anão de Vidro} --- Nada disso! Você ainda terá que passar por alguns
...
\versal{Anão de Vidro}, \emph{sussurrando} --- O que está acontecendo? Por que a
gente não continua?
...
\versal{Rei do Tablado}, \emph{sussurrando} --- Isso é fatal, fatal! Mas o que a
gente vai fazer?
...
vá cantar a ``Guarda do Reno''.\footnote{\emph{Die Wacht am Rhein} é uma
  ...
  notar de forma ainda expressiva tanto na Primeira quanto na Segunda
...
negociar com o senhor? Não vai querer que eu seja seu servo? Que mais
...
\versal{Peter Munk do Carvão}, \emph{assustado} --- O quê? Dar meu coração ao
...
coração do Rei do Tablado e aquele é o do guarda"-florestal. E aqui temos
...
angustiado, e seus antigos donos estão muito contentes por ter expulsado
...
mármore? Mas ouça, Sr.\,Miguel, esse coração deve ser frio no peito.

\versal{Miguel o Holandês} --- Claro, mas é frio de uma forma agradável. Por que
um coração deveria ser quente? No inverno, o calor não tem utilidade
...
sensato. Venha cá, vamos tomar outro gole e depois vou desembolsar o
dinheiro.
...
ficando melancólico, já que estou saindo pela primeira vez da floresta
...
coração, vou achar muito bom. De fato, há aqui uma bolsa com milhares
de táleres e cartas de crédito de casas de comércio de todas as grandes
cidades.
...
caiqouettes,\footnote{Termo pseudofrancês, criado pelos autores da peça.
...
Trata"-se de um relógio cuco, que pertence à família há muitas
...
\versal{Lisbete} --- Mas por quê? Você nem sabe quem é.
...
o que acontece quando a gente deixa esse tipo de pessoa entrar na nossa casa?
É uma gentalha de mendigos. Uma pessoa conta para a outra.
...
depois que o relógio der a décima terceira batida, ele volta a si, cai em
...
\versal{Peter} --- Ele nunca vai me devolver o meu coração.

\versal{Anão de Vidro}, \emph{depois de uma pausa} --- Estou com pena de você, por
mais que você seja mau. Mas, como seu desejo não é tolo, pelo menos, não lhe
posso recusar a minha ajuda. Consegue guardar um verso?
...
ficar com a Lisbete, aquele muro de lamentações, que desperdiça todo esse
...
\versal{Locutor} --- Ah não, até a gente achar alguma coisa nessa Terra da Voz, é
...
com o Peter na Terra da Voz? Mas como faço para ser notado por ela?
Não quero chamá"-la simplesmente. A minha voz de urso a assustaria, mesmo
...
pequeno Peter. --- Agora vocês podem me agradecer. Não vocês, crianças que nos ouviram,
...
e todo esse monte de personagens de Hauff\footnote{Benjamin faz aqui um
  jogo de palavras ``\emph{Haufen} \emph{Leute von Hauff''}. [\versal{N}.\,\versal{E}.]} que levei para a Terra da Voz a pedido deles e que deixei sãos
...
bandidos ainda piores. Leiam, por exemplo, ``O navio dos fantasmas'', ``A
...
\chapter{A Berlim demoníaca\,\footnote[*]{``Das dämonische Berlin'',
  ...
  infantil dos contos de \textsc{e.t.a.} Hoffmann, descrita neste texto, também
...
entrou na Capela para nos ler histórias de \textsc{e.t.a.} Hoffmann,
...
Hoffmann não foram simplesmente inventadas pelo contador de histórias consigo mesmo
...
andar, nas mãos ou na forma da cabeça delas. Por isso, Hoffmann era
...
``capital'', o Jardim Zoológico de ``parque'', o Spree de ``rio'', até surgir
...
comovente nos clientes da taberna se transformou em um estudo para suas
obras, ou então o colocava --- Hoffmann era um desenhista muito hábil ---
com sua pena expressiva no papel. Mas ai quando as pessoas que se
encontravam na taberna não lhe eram agradáveis; quando cabeças limitadas
...
fins com elas. Contudo, podemos lê"-las como se ele tivesse se
...
do meu primo}.\footnote{Há edição brasileira. Cf. \textsc{e.t.a.} Hoffmann,
...
apartamento que dava para a \emph{Gendarmenmarkt}.\footnote{Praça do centro histórico de Berlim, nas proximidades da Avenida \emph{Unter den Linden}. [\versal{N.\,E.}]} Na
...
\chapterspecial{Conversa assistindo ao corso}{Ecos do carnaval de Nice\,\footnote[*]{``Gespräch über dem
  ...
  Zeitung} de 24 de março de 1935 sob o pseudônimo de Detlef Holz.
  [\versal{N}.\,\versal{E}.]}}{}
...
Ela anunciava a chegada do carro"-chefe com o Príncipe Carnaval.%Aparece sem o "do" nas outras ocorrências 
...
Felpudo},\footnote{\emph{Max und Moritz} (1865), do escritor e
  ...
  Iluminuras, 2011, para apenas referirmos uma edição recente. [\versal{N}.\,\versal{E}.]} mas também os tornou úteis. Pois essas características se
...
\hspace*{\parindent}--- Pois é, a gente tem que ter mão de ouro, falou o dinamarquês.
...
\chapter[Jakob Job, \emph{Nápoles. Imagens de viagem e esboços}]{Jakob Job, \emph{Nápoles. Imagens de viagem e esboços}. Zurique: Rascher \& Cia. \textsc{a.-g.} 1928. 255\,p. 32\,figuras\footnote[*]{``Jakob Job, \emph{Neapel. Reisebilder und
  ...
  periódico \emph{Die Literarische Welt} de 20 de julho de 1928. [\versal{N}.\,\versal{E}.]}}

  %{\begin{center}\footnotesize{Zurique: Rascher \& Cia. \textsc{a.-g.} 1928. 255\,p. 32\,figuras}\end{center}}{}
% \footnote
...
%   da \versal{O}.]} }{}
\hedramarkboth{Jakob Job}{}

\noindent{}Amar Nápoles olhando do mar é fácil. No entanto, basta pôr o pé em
...
Acrescente"-se a isso as experiências do primeiro dia para ver que poucas
...
eterno, ainda que seja pelo fato de seu alemão ser o mais incorreto que
se possa imaginar.

Passamos as páginas e encontramos títulos promissores: ``Camaldoli'',
...
%\hfill{}Walter Benjamin

%\begin{enumerate}
%\def\labelenumi{\scshape\roman{enumi}.}
%\item
  %\emph{Anedotas desconhecidas}
%\end{enumerate}

\section{I Anedotas desconhecidas}
...
Uma história sem a qual ninguém entenderá a \emph{Crítica da faculdade de julgar}
...
e encontrado alguns filhotes espatifados no chão. Admirado com
...
\section{II Kant como conselheiro do amor\protect\footnoteInSection{\MakeUppercase{S}egundo os editores
alemães dos \emph{\MakeUppercase{G}esammelte \MakeUppercase{S}chriften}, a segunda parte das
anedotas, ``\textsc{ii}. \MakeUppercase{K}ant como conselheiro do amor'', não pode ser
atribuída com certeza a \MakeUppercase{B}enjamin, mas foi certamente elaborada a
partir de sugestão dele. [\textsc{n}.\,\textsc{e}.]}}
...
%\chapterspecial{O crítico e o contador de histórias}{}{Patrícia Lavelle}
\chapter[O crítico e o contador de histórias, \textit{por Patrícia Lavelle}]{O crítico e o contador de histórias}
\hedramarkboth{O crítico e o contador de histórias}{}

\begin{flushright}
\hfill\textsc{patrícia lavelle}\smallskip
\end{flushright}

\section{A crítica: entre literatura e filosofia}

\noindent{}A geração de intelectuais alemães que ainda fora à escola num bonde
...
o seu segredo.\footnote{Idem, p. 113; \versal{GS} \versal{I}-1, p. 195.}
\end{quote}
...
Nesse sentido, o conceito de crítica de arte leva"-nos a pensar a
...
de sua mão na argila do vaso''.\footnote{\emph{Supra}, p.\,\pageref{supra} (\versal{GS} \versal{II}-2, p.\,447).} A experiência transmissível da tradição é, segundo Benjamin, a
...
Não é por acaso que esse conto acerca do contador se abre com a
