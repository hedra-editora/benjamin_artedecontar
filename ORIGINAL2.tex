...
\versal{Anão de Vidro} --- A soberba vem amiúde antes da queda.\footnote{A
  passagem aluda ao seguinte versículo bíblico do livro dos
...
vá cantar a ``Guarda do Reno''.\footnote{\emph{Die Wacht am Rhein} é uma
  ...
  escrito em 1840. A canção celebrizou-se na Guerra Franco-Prussiana, tendo-se
...
apartamento que dava para a \emph{Gendarmenmarkt}\footnote{Praça do centro histórico de Berlim, nas proximidades da avenida Unter den Linden. [\versal{N. E.}]}. Na
...
as coisas mais de perto, lembrou-se do velho costume de rebatizar as
...
interesse sério que tomou conta de mim, quando, de repente, pedi que
meus companheiros esperassem por mim na rua para que eu desse alguns
