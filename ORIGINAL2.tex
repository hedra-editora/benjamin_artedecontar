...
\chapter{No minuto exato\,\footnote{``Auf die Minute'', in \versal{GS} IV-2, pp. 761-763.
...
\chapter{Caspar Hauser\,\footnote{``Caspar Hauser'', in \versal{GS} VII-1, pp.
...
\chapterspecial{O Coração Gelado\,\footnote{``Das Kalte
  Herz. Hörspiel nach Wilhelm Hauff'', in \versal{GS} VII-1, pp. 316-346.
  Tradução de Georg Otte, com a colaboração de Francisco De Ambrosis
  Pinheiro Machado. [N. E.]}\footnote{Peça radiofônica para
  ...
  aniversário. [N. da O.]}}{Peça de rádio baseada em Wilhelm Hauff}{Walter Benjamin e Ernst Schoen}
...
\chapter{A Berlim demoníaca\,\footnote{``Das dämonische Berlin'', in \versal{GS}
...
\chapterspecial{Conversa assistindo ao corso}{Ecos do carnaval de Nice\,\footnote{``Gespräch über dem
  \emph{Corso}. Nachklänge vom Nizzaer Karneval'', in \versal{GS} IV-2, pp.
  763-771. Tradução de Georg Otte. [N. E.]}\footnote{Texto
...
\chapterspecial{A mão de ouro}{Uma conversa sobre o jogo\,\footnote{``Die glückliche Hand. Eine
  Unterhaltung über das Spiel'', in \versal{GS} IV-2, pp. 771-777. Tradução de
  Georg Otte. [N. E.]}\footnote{Texto provavelmente escrito logo
...
``Nove para a banca'', disse o crupiê\footnote{No original alemão,
  ``\emph{Neuf à la banque}'', em francês. [N. E.]}; ela havia
...
%   A.-G. 1928. 255 S., 32 Abb.'', in \versal{GS} III, pp. 132-135. Tradução de
...
ANEDOTAS DESCONHECIDAS DE KANT\footnote{``Unbekannte Anekdoten von
  Kant'', in \versal{GS} IV-2, pp. 808-815. Tradução de Georg Otte. [N.
...
na qual tantos depositaram suas esperanças.\footnote{Walter Benjamin,
  ...
  [daqui em diante: \versal{GS}], v. II-1. Frankfurt a. M.: Suhrkamp, 1991,
  p. 214.}
\end{quote}
...
ocuparam, é apenas uma parcela deste vasto domínio.\footnote{Walter
  Benjamin, \emph{Gesammelte Briefe} [daqui em diante: GB], v. II.
...
\versal{XIX}, encontra sua expressão literária no romance burguês e sua forma
