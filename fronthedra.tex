...
\linhalayout{coordenação científica e editorial da coleção W.Benjamim}{Amon Pinho}
\linhalayout{supervisão técnica e de tradução}{Francisco De Ambrosis Pinheiro Machado}


{\tiny
\hspace*{-6pt}\begin{tabular}{ll}    
\textbf{revisão de tradução} & Francisco De A. P. Machado,\\
						 & Amon Pinho,\\
						 & Patrícia Lavelle,\\
						 & Blima Carvalho Otte
...
\linha{sobre o apoio}{\patrociniomensagem}\medskip
...
Amon Pinho\\
Francisco De Ambrosis Pinheiro Machado\par}
\medskip
