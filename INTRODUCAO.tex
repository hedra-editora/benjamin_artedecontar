%!TEX root=./LIVRO.tex
\chapter*{\textit{Coligir, traduzir, editar Walter Benjamin}\\ notas sobre uma Coleção que inicia}
...
Patrícia Lavelle (\versal{PUC}-\versal{R}io) se devem, os leitores encontrarão,
...
-- nas traduções realizadas por Georg Otte (\versal{UFMG}), Marcelo Backes
