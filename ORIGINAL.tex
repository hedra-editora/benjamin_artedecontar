...
Leskov\,\footnote[*]{Tradução de Patrícia Lavelle a partir do
  ...
  Réflexions à propos de l'oeuvre de Nicolas Lesskov'', in Walter
...
Sealsfield e Gerstäcker vêm da segunda.\footnote{Johann Peter Hebel
  ...
  [\versal{N}. da \versal{T}.]} No entanto, tais linhagens, como foi dito,
...
inteligência do mundo\footnote{``sua experiência dos homens'', na
  variante da versão francesa. [\versal{N}. da \versal{T}.]} quanto seu conhecimento
...
Nas lendas russas, Leskov\footnote{``Leskov, que não escondia suas
  ...
  versão francesa. [\versal{N}. da \versal{T}.]} encontrou aliados em sua luta contra
...
ciência natural na \emph{Caixinha de tesouros},\footnote{Referência à
  ...
  (\emph{Schatzkästlein des Rheinischen Hausfreundes}). [\versal{N}. da \versal{T}.]}
...
uma nova beleza ao que está desaparecendo.\footnote{Na variante da
  ...
  gênero que se vai.'' [\versal{N}. da \versal{T}.]}
...
centelha de sabedoria.\footnote{Na versão francesa, o capítulo termina
  ...
  alemão, foi eliminada pelo autor. [\versal{N}. da \versal{T}.]} Quando ao longo dos
...
pensar em textos como ``A fraude'' ou ``A águia branca'').\footnote{Ambos
  ...
  (tradução de Paulo Bezerra, 2009). [\versal{N}. da \versal{T}.]} Ele
...
todos os diques''.\footnote{Cf. Michel de Montaigne, \emph{Essais},
  ...
  Pléiade). [\versal{N}. da \versal{T}.]} Isso disse Montaigne. Mas poderíamos também
...
o seu poder de germinar.\footnote{Por volta de 1928---1929, Benjamin
  ...
  696).'' Cf. \versal{GS} \versal{IV}-2, p. 1011. [\versal{N}. da \versal{T}.]}
...
fraude''\footnote{Cf. Nikolai Leskov, \emph{A Fraude e outras
  histórias}, ed. cit. [\versal{N}. da \versal{T}.]} com a descrição de uma viagem de
...
Sonata a Kreutzer}''\footnote{Idem, ibidem. [\versal{N}. da \versal{T}.]}; ou faz
...
relata em ``Homens interessantes''.\footnote{Cf. Nikolai Leskov,
  \emph{Homens interessantes e outras histórias}, ed. cit. [\versal{N}. da
...
Leskov não é lido. É um escritor verídico''.\footnote{Citado por Erich
  ...
  p. 313. (\emph{Gesammelte Werke}, v. \versal{IX}) [\versal{N}. da \versal{T}.]} Numa
...
A imagem\footnote{Na variante da versão francesa: ``lei''. [\versal{N}. da
...
sucessivas e semelhantes''.\footnote{Paul Valéry, ``Les broderies de
  Marie Monnier'', \emph{Pièces sur l'art}, in~\emph{Oeuvres}, tomo \versal{II}.
  Edição de Jean Hytier. Paris: Gallimard, 1960, p. 1244. (Col.
  Bibliothèque de la Pléiade). [\versal{N}. da \versal{T}.]} Mas a acumulação de tais
...
abreviado''.\footnote{Idem, ibidem. [\versal{N}. da \versal{T}.]} De fato, conseguiu
...
das camadas acumuladas por suas diferentes versões.\footnote{``Fomos
  ...
  si.'', conforme variante da versão francesa. [\versal{N}. da \versal{T}.]}
...
a aversão crescente por tarefas demoradas''.\footnote{Paul Valéry, ``Les
  broderies de Marie Monnier'', \emph{op. cit.}, p. 1244. [\versal{N}. da \versal{T}.]}
...
encontra em ``Reencontro inesperado'',\footnote{Na versão francesa,
  ``Reencontro inesperado dos Amantes. [\versal{N}. da \versal{T}.]} conto
...
de Falun.\footnote{``(\ldots{}) nas minas de Falun na Suécia'', consoante o
  acréscimo pontual da versão francesa. [\versal{N}. da \versal{T}.]} Na véspera do
...
Falun, no ano de 1809\ldots{}''\footnote{Johan Peter Hebel, \emph{Sämtliche
  Werke}, v. \versal{III}. Karlsruhe: Müller, 1834, p. 188. [\versal{N}. da \versal{T}.]}
...
nada. O seu tempo de falar ao homem já virou passado''.\footnote{Nikolai
  ...
  cit., p. 160. [\versal{N}. da \versal{T}.]}
...
contador é determinada pelo interesse em guardar o que foi contado.\footnote{Neste capítulo, Benjamin utiliza termos que cobrem o campo
  ...
  distinção que não aparece no original alemão. [\versal{N}. da \versal{T}.]} O
...
A \emph{recordação}\footnote{\emph{Erinnerung}, no original alemão;
  \emph{mémoire}, na versão francesa. [\versal{N}. da \versal{T}.]} estabelece a
...
\emph{memória}\footnote{\emph{Gedächtnis}, no original alemão;
  \emph{mémoire}, na versão francesa. [\versal{N}. da \versal{T}.]} épica e a musa
...
estrito.\footnote{Na variante da versão francesa: ``Encontra-se um
  ...
  unidade indivisa do gênero épico.'' [\versal{N}. da \versal{T}.]} Às vezes, já
...
anuncia em tais passagens é a memória perpetuadora\footnote{\emph{Verewigende
  ...
  versão francesa. [\versal{N}. da \versal{T}.]} do romancista em oposição à memória
divertida\footnote{\emph{Kurzweilige Gedächtnis}, no original alemão;
  \emph{souvenir passe-temps}, na versão francesa. [\versal{N}. da \versal{T}.]} do
...
fatos dispersos. Em outras palavras: a \emph{Rememoração}\footnote{\emph{Eingedenken},
  ...
  na tradução. [\versal{N}. da \versal{T}.]}, musa do romance, surge ao lado da
memória\footnote{\emph{Gedächtnis}, no original alemão; \emph{souvenir},
  na versão francesa. [\versal{N}. da \versal{T}.]}, musa do conto, depois que a
unidade de sua origem na Recordação\footnote{\emph{Erinnerung}, no
  original alemão; \emph{mémoire}, na versão francesa. [\versal{N}. da \versal{T}.]}
...
modo de agir e omitir, se deposita como o resíduo\footnote{``(\ldots{}) resíduo do
  vinho'', na variante da versão francesa. [\versal{N}. da \versal{T}.]} no fundo do
...
contos\footnote{``(\ldots{}) através de seus relatos de terras longínquas'',
  consoante acréscimo efetuado por Benjamin na versão francesa. [\versal{N}. da
...
dos ouvintes.\footnote{``De fato, não vemos entre os contistas árabes o
  ...
  acréscimo da versão francesa. [\versal{N}. da \versal{T}.]} Deixaram marcas
...
a saber, dialeticamente, em astúcia e em ousadia).\footnote{Benjamin faz,
  ...
  a~\emph{List}, ``astúcia''. [\versal{N}. da \versal{T}.]} A magia liberadora do
...
fora''.\footnote{Citação de Ernst Bloch, \emph{Erbschaft dieser Zeit}.
  ...
  da \versal{T}.]} Redimidas, ``como nos contos de fadas'', são aquelas
...
Macbeth do Distrito de Mtzensk}.\footnote{Cf. Nikolai Leskov, \emph{Lady
  Macbeth do Distrito de Mtzensk}, ed. cit. [\versal{N}. da \versal{T}.]} Se a
...
o fez.''\footnote{Nikolai Leskov, ``A voz da natureza'', in \emph{A
  Fraude e outras histórias}, ed. cit., p. 100. [\versal{N}. da \versal{T}.]} A
...
uma casa bonitinha, de madeira (\ldots{})''.\footnote{Idem, ibidem, p. 90.
  [\versal{N}. da \versal{T}.]} Como se vê, essa história mostra a tradicional
...
\emph{Dieter}.\footnote{Alusão a uma série de contos de Hebel nos quais
  ...
  [\versal{N}. da \versal{T}.]} E, claro, também para Hebel o justo desempenha o papel
...
sou inclinado a pensar como penso.''\footnote{Nikolai Leskov, ``A
  ...
  histórias}, ed. cit., pp. 176---177. [\versal{N}. da \versal{T}.]} É verdade, por
...
ódio de Hagen.\footnote{Personagem da mitologia escandinava e, depois,
  ...
  Siegfried. [\versal{N}. da \versal{T}.]} É surpreendente como, nesse autor, o mundo
...
braço e\ldots{} pôs-se a chorar.''\footnote{Nikolai Leskov, ``Alexandrita'',
  in \emph{A Fraude e outras histórias}, ed. cit., pp. 164---165. [\versal{N}. da
  \versal{T}.]}
...
evocá-los''.\footnote{Paul Valéry, ``Autour de Corot'', \emph{Pièces sur
  l'art}, in~\emph{Oeuvres}, tomo~\versal{II}. Edição de Jean Hytier. Paris:
  Gallimard, 1960, p. 1318. (Col. Bibliothèque de la Pléiade). [\versal{N}. da
  \versal{T}.]}
...
mão.\footnote{``Relação de colaboração que determina todo trabalho
  artesanal'', conforme acréscimo efetuado na versão francesa. [\versal{N}. da
...
humana,\footnote{``a experiência humana'', segundo variação da versão
  francesa. [\versal{N}. da \versal{T}.]} não seria ela própria uma relação
...
provérbio, mas em muitos,\footnote{Na variante da versão francesa: ``em
  todos os casos''. [\versal{N}. da \versal{T}.]} como o sábio. Pois lhe é dado
...
narração. Daí vem essa atmosfera\footnote{``esse halo'', na variante da
  versão francesa. [\versal{N}. da \versal{T}.]} incomparável que, em Leskov como em
...
paralela.\footnote{Esta passagem figura igualmente numa resenha de 1928,
  ...
  \emph{Vide} página \textbf{\emph{\versal{XX}}}, adiante. [\versal{N}. \versal{E}.]} Eu
...
\chapter{Palácio \versal{D}\ldots{}\versal{Y}\footnote[*]{``Palais \versal{D}\ldots{}y'', in \versal{GS} \versal{IV}-2, pp.
...
escada do Palácio \versal{D}\ldots{}y era aquele valioso móvel Chippendale que certo
...
\chapterspecial{``Inscrito na poeira movediça''}{Novela\footnote[*]{``Dem Staub,
  ...
  \versal{E}.]}\footnote[*]{Verso do ``Divan ocidental-oriental'', de Johann
  Wolfgang von Goethe. [\versal{N}. do \versal{T}.]}}{}
...
\chapter{Uma história estranha, \\de quando ainda não havia humanos\,\footnote[*]{``Eine komische Geschichte, als es noch keine
  ...
  quando Benjamin regressava à Paris desde Ibiza. [\versal{N}. \versal{E}.]} }
