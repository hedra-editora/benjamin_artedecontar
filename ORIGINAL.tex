...
traduzir sua obra \emph{Sobre os Princípios}.\footnote{Há tradução para
  ...
  (Coleção Patrística, v. 30) [N. dos E.]} De acordo com as
...
\emph{Histórias dos velhos tempos}\footnote{``Erzählungen aus der alten
  ...
  [N. dos E.]} vão até o fim em sua paixão sem escrúpulos. E esse
...
vermelha\footnote{Na tradução do russo para o alemão de que fez uso
  ...
  E.]}, e pôs-se a gritar: --- (\ldots{}) Vejam só, eis aqui aquela pedra
...
\chapter{O anoitecer da viagem\footnote{``Der Reiseabend'', in \versal{GS} IV-2, pp.
  ...
  correio, seguiu para Ibiza, onde ficou por três meses. [N. dos E.]}\footnote{Um
...
\chapter{Uma história estranha, \\de quando ainda não havia humanos\,\footnote{``Eine komische Geschichte, als es noch keine Menschen
  gab'', in \versal{GS} VII-1, p. 300. Tradução de Marcelo Backes. [N. dos
...
\chapterspecial{Myslowitz --- Braunschweig --- Marselha}{História de uma embriaguez com haxixe\,\footnote{``Myslowitz -
  ...
  in \versal{GS} IV-2, pp. 729-737. Tradução de Georg Otte. [N. dos E.]}\footnote{No
