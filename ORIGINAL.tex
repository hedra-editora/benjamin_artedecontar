...
%\textsc{Mysłowitz -- Braunschweig -- Marselha. História de uma
...
\chapterspecial{O contador de histórias}{Considerações sobre a obra\break de Nikolai
Leskov\,\footnote[*]{Tradução de Patrícia Lavelle a partir do
  original alemão ``Der Erzähler. Betrachtungen zum Werk Nikolai
  Lesskows'' em cotejamento com a versão francesa desse mesmo ensaio,
  ...
  a revista parou de circular. Essa versão francesa, que foi confiada à
  Adrienne Monnier, personagem influente no meio literário parisiense,
  seria publicada somente em 1952, no \emph{Mercure de France}. [\versal{N}.\,\versal{E}.]}}{}

\section{\versal{I}}

\noindent{}Embora seu nome soe familiar, o contador de histórias não está mais
...
distanciamento, os traços grandes e simples que caracterizam o contador de histórias
...
representa o contador de histórias como aquele que vem de longe. Mas também é com
...
modo, sua própria linhagem de contadores de histórias. Cada uma delas manteve algumas
...
é confiado, preferencialmente, ao sedentário.\footnote{Na versão em
  ...
  assim que se constitui esse personagem do contador de histórias que, como bem disse
...
regra de vida --- em cada um desses casos, o contador de histórias é um homem que sabe
...
uma nova beleza ao que está desaparecendo.\footnote{Na variante da
  ...
  consistindo em forças seculares que pouco a pouco separaram o contador de histórias
...
quanto mais naturalmente o contador de histórias renuncia aos detalhes psicológicos,
...
daquele que a relata para em seguida daí retirá"-la. O contador de histórias deixa sua
...
relata em ``Homens interessantes''.\footnote{Cf. Nikolai Leskov,
  \emph{Homens interessantes e outras histórias}, ed. cit. [\versal{N}.\,\versal{T}.]} Assim, deixa sua marca naquilo que conta de diversos modos,
...
A imagem\footnote{Na variante da versão francesa: ``lei''. [\versal{N}.\,\versal{T}.]} espiritual dessa esfera artesanal da qual provém o contador de histórias
...
poesia ingênua. O contador de histórias permanece fiel a ela e seu olhar não se
...
encarnada pelo contador de histórias. Ela tece a rede formada por todas as histórias.
...
inexprimível''.\footnote{Cf. Georg Lukács, \emph{Die Theorie des
  ...
  romance}, ed. cit., pp. 128--136. [\versal{N}.\,\versal{E}.]}
...
grande contador de histórias terá sempre suas raízes no povo, e em primeiro lugar nas
...
contos,\footnote{``(\ldots{}) através de seus relatos de terras longínquas'',
  conforme acréscimo efetuado por Benjamin na versão francesa. [\versal{N}.\,\versal{T}.]} quanto refinar as estratégias destinadas a captar a atenção
...
britânicos. Por outro lado, todos os grandes contadores de histórias têm
...
fora''.\footnote{Citação de Ernst Bloch, \emph{Erbschaft dieser Zeit}.
  Frankfurt a. \versal{M}.: Suhrkamp, 1962. (\emph{Gesammtausgabe}, v. 4) [\versal{N}.\,\versal{T}.]} Redimidas, ``como nos contos de fadas'', são aquelas
...
consolação do mundo amontoam"-se em torno do contador de histórias. Estão todos
...
corresponde à camada mais baixa da criação. Mas para o contador de histórias, ela se
...
mão.\footnote{``Relação de colaboração que determina todo trabalho
  artesanal'', conforme acréscimo efetuado na versão francesa. [\versal{N}.\,\versal{T}.]} Interagindo, determinam uma prática com a qual não estamos mais
...
além e nos perguntar se a relação do contador de histórias com sua matéria, a vida
...
experiência, mas também uma boa parte da experiência alheia. O contador de histórias
...
parecia faltar o que é a coisa mais maravilhosa no contador de histórias: o fato de
...
Eu ainda tinha no ouvido a voz com a qual o contador de histórias havia pronunciado
...
\noindent{}Eu vivia há alguns meses em um ninho nas rochas, na Espanha. Muitas
...
\noindent{}Junto a um lugar de excursão, não muito distante de Tsingtao, havia uma
...
rochosa. Sobre uma tabuleta pendurada nele, era possível ler:
...
\chapterspecial{«Inscrito na poeira movediça»}{Novela\footnote[*]{``Dem Staub,
  ...
  Tradução de Georg Otte. Conto escrito provavelmente em 1929. [\versal{N}.\,\versal{E}.]}\footnote[*]{Verso do \textit{Divã ocidental"-oriental}, de Johann
...
\chapterspecial{O segundo eu}{Uma história de final\break de ano para refletir\,\footnote[*]{``Das
...
\chapter[Por que o elefante se chama «elefante»]{Por que o elefante se\break chama «elefante»\,\footnote[*]{``Warum der Elefant
...
\chapter[Como o barco foi inventado e por que\\ ele se chama «barco»]{Como o barco foi inventado \\e por que ele se chama «barco»\footnote[*]{``Wie
...
\chapter[Uma história estranha, de quando ainda\\ não havia humanos]{Uma história estranha, \\de quando ainda não havia humanos\,\footnote[*]{``Eine komische Geschichte, als es noch keine
...
\chapterspecial{Mysłowitz -- Braunschweig -- Marselha}{História de uma embriaguez\break com haxixe\,\footnote[*]{``Mysłowitz
  ...
  \hedramarkboth{Mysłowitz -- Braunschweig -- Marselha}{}
...
cereais?' De repente eu soube que se tratava de Mysłowitz. Levantei o
olhar e, nesse momento, vi realmente, no final da praça, não, mais longe
ainda, no final da cidade, o ginásio de Mysłowitz e o relógio da escola
