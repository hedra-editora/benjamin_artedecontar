...
estrito.\footnote{Na variante da versão francesa: ``Encontra-se um
  ...
  unidade indivisa do gênero épico, um outro princípio inspirador.''
...
traduzir sua obra \emph{Sobre os Princípios}.\footnote{Cf. Orígenes. \emph{Tratado sobre os
...
sob a nuca. A moça era muito bonita, mas tão chamativa quanto
...
drásticos, os homens dançavam \emph{shimmy} uns com os outros à tarde, e
...
Mais tarde, ficou provado que os balizamentos estavam falsificados. Mais tarde
...
\chapter{O anoitecer da viagem\footnote[*]{``Der Reiseabend'', in \versal{GS} \versal{IV}-2, pp.
  ...
  de Hamburgo a Barcelona em um navio cargueiro. A viagem durou onze
...
de pior fama jamais ouvira qualquer alusão a ele, não se poderia
