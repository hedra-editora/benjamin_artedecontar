...
Leskov\,\footnote{Tradução de Patrícia Lavelle a partir do original
  ...
  cotejamento com a versão francesa desse mesmo ensaio, realizada pelo
  ...
  Schriften} [a partir daqui, \versal{GS}], v. \versal{II}, tomos 2 e 3. Edição de
  Rolf Tiedemann e Hermann Schweppenhäuser. Frankfurt a. M.: Suhrkamp,
  1991, pp. 438---465 e 1290---1309, respectivamente. [N. E.]}\footnote{Escrito
  ...
  Provavelmente entre julho e outubro de 1936, ou entre esse período e
  ...
  de circular. Essa versão francesa, que foi confiada à Adrienne
...
longínquo, e fica cada vez mais distante. Apresentar um Leskov\footnote{Nikolai
  ...
  coletânea em nove volumes da Editora C. H. Beck. [N. de \versal{W.B.}]}
...
pensar em textos como ``A fraude'' ou ``A águia branca'').\footnote{Ambos
  ...
  (tradução de Paulo Bezerra, 2009). [N. da T.]} Ele
...
o seu poder de germinar.\footnote{Por volta de 1928---1929, Benjamin
  ...
  696).'' Cf. \versal{GS} \versal{IV}-2, p. 1011. [N. da T.]}
...
Leskov não é lido. É um escritor verídico''.\footnote{Citado por Erich
  ...
  p. 313. (\emph{Gesammelte Werke}, v. IX) [N. da T.]} Numa
...
A imagem\footnote{Na variante da versão francesa: ``lei''. [N. da
  T.]} espiritual dessa esfera artesanal da qual provém o contador
...
encontra em ``Reencontro inesperado'',\footnote{Na versão francesa,
  ``Reencontro inesperado dos Amantes. [N. da T.]} conto
...
Falun, no ano de 1809\ldots{}''\footnote{Johan Peter Hebel, \emph{Sämtliche
  Werke}, v. \versal{III}. Karlsruhe: Müller, 1834, p. 188. [N. da T.]}
...
contador é determinada pelo interesse em guardar o que foi contado.\footnote{Neste capítulo, Benjamin utiliza termos que cobrem o campo
  ...
  distinção que não aparece no original alemão. [N. da T.]} O
...
(\ldots{})\footnote{A passagem suprimida neste ponto da citação, feita por
  ...
  São Paulo: Editora 34: Duas Cidades, 2009, p. 130. [N. E.]}
...
inexprimível''.\footnote{Cf. Georg Lukács, \emph{Die Theorie des
  ...
  romance}, ed. cit., pp. 128---136\emph{.} [N. E.]}
...
traduzir sua obra \emph{Sobre os Princípios}.\footnote{Há tradução para
  ...
  (Coleção Patrística, v. 30) [N. E.]} De acordo com as
...
fora''.\footnote{Citação de Ernst Bloch, \emph{Erbschaft dieser Zeit}.
  Frankfurt a. M.: Suhrkamp, 1962. (\emph{Gesammtausgabe}, v. 4) [N.
...
uma casa bonitinha, de madeira (\ldots{})''.\footnote{Idem, ibidem, p. 90.
  [N. da T.]} Como se vê, essa história mostra a tradicional
...
ódio de Hagen.\footnote{Personagem da mitologia escandinava e, depois,
  ...
  Siegfried. [N. da T.]} É surpreendente como, nesse autor, o mundo
...
\emph{Histórias dos velhos tempos}\footnote{``Erzählungen aus der alten
  ...
  [N. E.]} vão até o fim em sua paixão sem escrúpulos. E esse
...
vermelha\footnote{Na tradução do russo para o alemão de que fez uso
  ...
  com iluminação artificial irradia um brilho vermelho''. [N. E.]}, e pôs-se a gritar: --- (\ldots{}) Vejam só, eis aqui aquela pedra
...
\chapter{O lenço\footnote{``Das Taschentuch'', in Walter Benjamin,
  \emph{Gesammelte Schriften} [a partir daqui, \versal{GS}], v. IV-2.
  Edição de Rolf Tiedemann e Hermann Schweppenhäuser. Frankfurt a. M.:
  Suhrkamp, 1991, pp. 741-745. Tradução de Marcelo Backes. [N.
...
\chapter{A viagem do mascote\footnote{``Die Fahrt der Mascotte'', in \versal{GS} IV-2, pp.
  738-740. Tradução de Marcelo Backes. [N. E.]}\footnote{Finalizado
...
\chapter{O anoitecer da viagem\footnote{``Der Reiseabend'', in \versal{GS} IV-2, pp.
  745-748. Tradução de Marcelo Backes. Quanto ao
  conjunto referido de notas (cf. \versal{GS} VI, pp. 446-464), Benjamin o
  ...
  correio, seguiu para Ibiza, onde ficou por três meses. [N. E.]}\footnote{Um
  ...
  provavelmente, no mesmo ano. [N. da O.]} }
...
\chapter{A sebe de cactos\footnote{``Die Kaktushecke'', in \versal{GS} IV-2, pp. 748-754.
  Tradução de Marcelo Backes. [N. E.]}\footnote{Este conto foi
...
paralela.\footnote{Esta passagem figura igualmente numa resenha de 1928,
  ...
  \emph{Vide} página \textbf{\emph{XX}}, adiante. [N. E.]} Eu
...
\chapter{Histórias da solidão\footnote{``Geschichten aus der Einsamkeit '', in \versal{GS}
  IV-2, pp. 755-757. Tradução de Marcelo Backes. [N. E.]}\footnote{De
...
\chapter{Quatro histórias\footnote{``Vier Geschichten'', in \versal{GS} IV-2, pp. 757-761.
  Tradução de Marcelo Backes. [N. E.]}\footnote{Esse conjunto de
...
\chapterspecial{A morte do pai}{Novela\,\footnote{``Der Tod des Vaters. Novelle'', in \versal{GS} IV-2, pp.
  723-725. Tradução de Marcelo Backes. [N. E.]}\footnote{Benjamin
...
\chapter{Palácio D\ldots{}Y\footnote{``Palais D\ldots{}y'', in \versal{GS} IV-2, pp.
  725-728. Tradução de Marcelo Backes. [N. E.]}\footnote{Conto
...
escada do Palácio D\ldots{}y era aquele valioso móvel Chippendale que certo
...
\chapterspecial{Inscrito na poeira movediça}{Novela\,\footnote{``Dem Staub, dem
  beweglichen, eingezeichnet. Novelle'', in \versal{GS} IV-2, pp. 780-787.
  Tradução de Georg Otte. [N. E.]}\footnote{Conto escrito
...
acontecer o grande concerto da tarde de V\ldots{}, onde todo sábado os
...
\chapterspecial{O segundo eu}{Uma história de final de ano para refletir\,\footnote{``Das
  zweite ich. Eine Sylvestergeschichte zum Nachdenken'', in \versal{GS} VII-1,
  pp. 296-298. Tradução de Marcelo Backes. [N. E.]}\footnote{Conto
...
\chapter{Rastelli conta\ldots{}\footnote{``Rastelli erzählt\ldots{}'', in \versal{GS} IV-2, pp.
  777-780. Tradução de Marcelo Backes. [N. E.]}\footnote{Conto
...
\chapter{Por que o elefante se chama ``elefante''\,\footnote{``Warum der Elefant
  `Elefant' heißt'', in \versal{GS} VII-1, pp. 298-299. Tradução de Marcelo
  Backes. [N. E.]}\footnote{Conto não publicado durante a vida
...
\chapter{Como o barco foi inventado \\e por que ele se chama ``barco''\,\footnote{``Wie
  das Boot erfunden wurde und warum es Boot heißt'', in \versal{GS} VII-1, p.
  299. Tradução de Marcelo Backes. [N. E.]}\footnote{Assim como
...
\chapter{Uma história estranha, \\de quando ainda não havia humanos\,\footnote{``Eine komische Geschichte, als es noch keine Menschen
  gab'', in \versal{GS} VII-1, p. 300. Tradução de Marcelo Backes. [N.
...
\chapterspecial{Myslowitz --- Braunschweig --- Marselha}{História de uma embriaguez com haxixe\,\footnote{``Myslowitz -
  ...
  in \versal{GS} IV-2, pp. 729-737. Tradução de Georg Otte. [N. E.]}\footnote{No
...
Embora suficientemente distante do bairro dos apaches\footnote{No
  ...
  e à vida noturna deste tipo de bairro nas grandes cidades. [N. E.]}, não havia
