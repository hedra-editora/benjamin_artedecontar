...
\chapter{A viagem do mascote\footnote[*]{``Die Fahrt der Mascotte'', in GS IV-2, pp.
...
\chapter{O anoitecer da viagem\footnote[*]{``Der Reiseabend'', in GS IV-2, pp.
  ...
  Quanto ao conjunto referido de notas (cf. GS VI, pp. 446-464),
  ...
  correio, seguiu para Ibiza, onde ficou por três meses. [N. E.]} }
...
\chapter{A sebe de cactos\footnote[*]{``Die Kaktushecke'', in GS IV-2, pp. 748-754.
...
\chapter{Histórias da solidão\footnote[*]{``Geschichten aus der Einsamkeit '', in GS
...
\chapter{Quatro histórias\footnote[*]{``Vier Geschichten'', in GS IV-2, pp. 757-761.
