...
Leskov}\footnote{Tradução de Patrícia Lavelle a partir do original
  ...
  Schriften} {[}a partir daqui, \textsc{GS}{]}, vol. \textsc{II}, tomos 2 e 3. Edição de
...
longínquo, e fica cada vez mais distante. Apresentar um Leskov\footnote{Nikolai
  ...
  coletânea em nove volumes da Editora C. H. Beck. {[}N. de \textsc{W.B.}{]}}
...
\section{XIII}\footnote{Neste capítulo, Benjamin utiliza termos que cobrem o campo
...
\chapter{Palácio D... Y}\footnote{``Palais D\ldots{}y'', in GS IV-2, pp.
...
\chapter{Rastelli conta...}\footnote{``Rastelli erzählt\ldots{}'', in GS IV-2, pp.
...
\chapter{No minuto exato}\footnote{``Auf die Minute'', in GS IV-2, pp. 761-763.
...
\chapter{Caspar Hauser}\footnote{``Caspar Hauser'', in GS VII-1, pp.
...
\chapterspecial{O Coração Gelado}{Peça de rádio baseada em Wilhelm Hauff}{Walter Benjamin e Ernst Schoen}\footnote{``Das Kalte
...
\textsc{Peter Munk do Carvão} --- Certo, Sr.ª Moendeira. Mas permita-me
...
\textsc{Anão de Vidro} --- ``... Seu Miguel, mas é o inferno que lhe manda.''
Repita.
...
\text{Locutor}, \emph{com voz grave} --- Sim, sim.
...
que diz mais, em sua breve carta,\footnote{Gilbert Clavel, Carta a Carl
  ...
  de \textsc{W.B.}{]}} da paisagem à sua volta do que o livro inteiro tratado
aqui.
