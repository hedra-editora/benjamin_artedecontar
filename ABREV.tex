...
\textit{G.B.} & \textit{Gesammelte Briefe} {[}Correspondência Reunida{]} \\
\textit{N. de W.B.} & Nota de Walter Benjamin \\
\textit{\begin{tabular}[c]{@{}r@{}}N. E.\\ \mbox{}\end{tabular}} & \begin{tabular}[c]{@{}l@{}}Nota Editorial (Patrícia Lavelle, Amon Pinho\\ e Francisco Pinheiro Machado)\end{tabular} \\
\textit{N. T.} & Nota do Tradutor (Patrícia Lavelle ou Georg Otte)
\end{tabular}
\end{table}
